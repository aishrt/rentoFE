...
/**
 * An original illustration of an NZ road at blue hour: layered alpine ridges, a low, pale sun and a
 * road winding into the hills. It stands in for the hero photography and video until the client's
 * art direction is approved (plan §12.1), and weighs a few KB instead of a 2 MB video. Its blues
 * share the primary's hue, and each keeps the lightness of the original scene so text over it
 * reads the same.
 */
